...
export default function GCAAConference() {
  ...
  return (
    <div className="min-h-screen bg-white font-['Poppins'] text-[#1e293b] overflow-x-hidden">
      ...
      <section id="home" ref={heroRef} className="relative h-screen flex justify-center items-center text-center text-white overflow-hidden">
        {/* Background elements */}
        <div className="absolute inset-0 z-0 bg-cover bg-center bg-fixed" style={{ backgroundImage: "url('/images/background.jpg')" }}></div>
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="prose prose-lg text-gray-700">
                      <p className="leading-relaxed">
                        We are pleased to announce the &quot;The Golden Conference Awards on Artificial Intelligence and Applications (GCA)&quot;,
